...
abstract class demo1 {   // abstract class //incomplete method is present thats why we use abstract class or we can say that abstract class is a class that cannot be instantiated and may contain abstract methods (methods without a body) as well as concrete methods (methods with a body).
...
public class Abstraction extends demo1 {  //concrete class that extends abstract class demo
