...
// Runtime polymorphism // Method overriding // methods are differentiated by the type of object that calls them
    ...
    class travel {
     ...
     class travelByCar extends travel {
        @Override
...
public class MethodOverriding {
    public static void main(String[] args) {
        ...
        travel myTravel = new travelByCar(); // Create an instance of travelByCar // if methods were static, we could call them directly without creating an instance ex.mo.travelByCar();
